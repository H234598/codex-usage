...
def _verified_manifest(tmp_path: Path, entrypoint: Path | None = None):
    """Synthetic attested 0.6.541 manifest for entrypoint isolation tests."""
    ...
    active_bytes = b'{"release_id":"0.6.541-aaaaaaaaaaaaaaaa","version":"0.6.541"}'
    ...
    return VerifiedActiveManifest(
        ...
        release_id="0.6.541-aaaaaaaaaaaaaaaa",
