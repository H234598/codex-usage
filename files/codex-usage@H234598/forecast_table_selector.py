#!/usr/bin/env python3
"""Show one prognosis table at a time behind a centered selector."""
...
class ForecastTableSelector(SettingsWidget, JSONSettingsBackend):
    """Render prognosis tables exclusively, selected by a centered dropdown."""
