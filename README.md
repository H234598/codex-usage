...
Die Dokumentation beschreibt den attestierten D299-Nachfolger `0.6.541`. Die vollständige Navigation steht in [docs/README.md](docs/README.md); der Implementierungsstatus steht in [ROADMAP.md](ROADMAP.md).
