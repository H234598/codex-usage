...
Die Dokumentation beschreibt den attestierten D300-Nachfolger `0.6.542`. Die vollständige Navigation steht in [docs/README.md](docs/README.md); der Implementierungsstatus steht in [ROADMAP.md](ROADMAP.md).
